                                ...
                                if (xarea / min_area > area_ratio_thresh)
                                  {
                                    ...
                                    if (naxo[na][no] > MAXXGRID)
                                      mpp_error ("naxo is greater than MAXXGRID, increase MAXXGRID");
                                  }
                              }
                          }
  ...
  for (na = 0; na < ntile_atm; na++)
    {
      ...
      for (nl = 0; nl < ntile_lnd; nl++)
        {
          (*atmxlnd_area_ptr)[na][nl] = (double *)malloc (MAXXGRID * sizeof (double));
          (*atmxlnd_ia_ptr)[na][nl] = (int *)malloc (MAXXGRID * sizeof (int));
          (*atmxlnd_ja_ptr)[na][nl] = (int *)malloc (MAXXGRID * sizeof (int));
          (*atmxlnd_il_ptr)[na][nl] = (int *)malloc (MAXXGRID * sizeof (int));
          (*atmxlnd_jl_ptr)[na][nl] = (int *)malloc (MAXXGRID * sizeof (int));
          if (interp_order == 2)
            {
              (*atmxlnd_clon_ptr)[na][nl] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxlnd_clat_ptr)[na][nl] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxlnd_dia_ptr)[na][nl] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxlnd_dja_ptr)[na][nl] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxlnd_dil_ptr)[na][nl] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxlnd_djl_ptr)[na][nl] = (double *)malloc (MAXXGRID * sizeof (double));
            }
        }

      for (no = 0; no < ntile_ocn; no++)
        {
          (*atmxocn_area_ptr)[na][no] = (double *)malloc (MAXXGRID * sizeof (double));
          (*atmxocn_ia_ptr)[na][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*atmxocn_ja_ptr)[na][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*atmxocn_io_ptr)[na][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*atmxocn_jo_ptr)[na][no] = (int *)malloc (MAXXGRID * sizeof (int));
          if (interp_order == 2)
            {
              (*atmxocn_clon_ptr)[na][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxocn_clat_ptr)[na][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxocn_dia_ptr)[na][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxocn_dja_ptr)[na][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxocn_dio_ptr)[na][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*atmxocn_djo_ptr)[na][no] = (double *)malloc (MAXXGRID * sizeof (double));
            }
        }
    }
}
  ...
  for (nl = 0; nl < ntile_lnd; nl++)
    {
      ...
      for (no = 0; no < ntile_ocn; no++)
        {
          (*lndxocn_area_ptr)[nl][no] = (double *)malloc (MAXXGRID * sizeof (double));
          (*lndxocn_il_ptr)[nl][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*lndxocn_jl_ptr)[nl][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*lndxocn_io_ptr)[nl][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*lndxocn_jo_ptr)[nl][no] = (int *)malloc (MAXXGRID * sizeof (int));
          if (interp_order == 2)
            {
              (*lndxocn_dil_ptr)[nl][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*lndxocn_djl_ptr)[nl][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*lndxocn_dio_ptr)[nl][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*lndxocn_djo_ptr)[nl][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*lndxocn_clon_ptr)[nl][no] = (double *)malloc (MAXXGRID * sizeof (double *));
              (*lndxocn_clat_ptr)[nl][no] = (double *)malloc (MAXXGRID * sizeof (double *));
            }
        }
    }
}
                          ...
                          if (xarea / min_area > area_ratio_thresh)
                            {
                              ...
                              if (nlxo[nl][no] > MAXXGRID)
                                mpp_error ("nlxo is greater than "
                                           "MAXXGRID, increase MAXXGRID");
                            }
                        }
                    }
            }
  ...
  for (nw = 0; nw < ntile_wav; nw++)
    {
      ...
      for (no = 0; no < ntile_ocn; no++)
        {
          (*wavxocn_area_ptr)[nw][no] = (double *)malloc (MAXXGRID * sizeof (double));
          (*wavxocn_iw_ptr)[nw][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*wavxocn_jw_ptr)[nw][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*wavxocn_io_ptr)[nw][no] = (int *)malloc (MAXXGRID * sizeof (int));
          (*wavxocn_jo_ptr)[nw][no] = (int *)malloc (MAXXGRID * sizeof (int));
          if (interp_order == 2)
            {
              (*wavxocn_clon_ptr)[nw][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*wavxocn_clat_ptr)[nw][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*wavxocn_diw_ptr)[nw][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*wavxocn_djw_ptr)[nw][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*wavxocn_dio_ptr)[nw][no] = (double *)malloc (MAXXGRID * sizeof (double));
              (*wavxocn_djo_ptr)[nw][no] = (double *)malloc (MAXXGRID * sizeof (double));
            }
        }
    }
}
                            ...
                            if (xarea / min_area > area_ratio_thresh)
                              {
                                ...
                                ++(nwxo[nw][no]);
                                if (nwxo[nw][no] > MAXXGRID)
                                  mpp_error (
                                      "nwxo is greater than MAXXGRID, "
                                      "increase MAXXGRID");
                              }
                          }
                      }
